        ...
        >
          ...
          <p style="font-size: 17px;">
            <v-chip id="chipMoveDest" outlined text color="#1d5df9"
              ><span id="destInner">Переместить в: </span
          ...
          <div class="float-right">
            ...
            <v-btn
              ...
              @click="moveFile()"
              >Переместить в выбранную папку</v-btn
            >
          </div>
        </b-modal>
  ...
  data() {
    return {
      dropzoneOptions: {
        ...
        thumbnailWidth: 150,
        maxFilesize: 10000,
        dictDefaultMessage: "Перетащите сюда файлы для загрузки на сервер",
        addRemoveLinks: true,
      ...
      folders: [],
      picked: "./files",
      moveDestination: "Не указан путь",
